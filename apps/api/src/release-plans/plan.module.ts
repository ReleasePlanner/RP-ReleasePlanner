...
import { PlanRcaController } from "./presentation/plan-rca.controller";
import { PlanRcaService } from "./application/plan-rca.service";
import { PlanRcaRepository } from "./infrastructure/plan-rca.repository";
...
@Module({
  imports: [
    TypeOrmModule.forFeature([
      ...
      PlanRca, // Import PlanRca for root cause analysis
    ...
    BasePhaseModule, // Import BasePhaseModule to access default phases
  ],
  controllers: [PlanController, PlanRcaController],
  providers: [
    PlanService,
    {
    ...
    PlanRcaService,
    {
      provide: "IPlanRcaRepository",
      useClass: PlanRcaRepository,
    },
  ],
  exports: [PlanService, "IPlanRepository", PlanRcaService, "IPlanRcaRepository"],
})
