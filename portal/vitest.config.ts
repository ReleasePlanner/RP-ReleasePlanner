...
export default defineConfig({
  test: {
    ...
    // Reduce parallelism to avoid EMFILE (too many open files) on Windows
    pool: "threads",
    poolOptions: {
      threads: {
        minThreads: 1,
    ...
    coverage: {
      ...
      exclude: [
        ...
        "src/features/releasePlans/components/Plan/PhasesList.tsx",
        "src/layouts/MainLayout.tsx",
        "src/store/store.ts",
        "src/features/releasePlans/lib/date.ts",
        "src/features/releasePlans/lib/phaseGenerator.ts",
        "src/features/releasePlans/lib/colors.ts",
        ...
        "src/features/releasePlans/components/Plan/MiniPhaseTimeline.tsx",
        "tailwind.config.*",
        "postcss.config.*",
        "vite.config.*",
        "eslint.config.*",
